...
void main(void)
{
  ...
  IncrementVcore();
    ...
    TA0CTL = TASSEL__ACLK + MC__CONTINUOUS + TACLR + ID_1;  //32 kHz for timer
    TA0CCTL1 = CCIE; // Enable CCR1 interrupt

    //sam timera channel 0
    TA0CCR0  = 1000;                      // about 1 ms 1Mcylespersecond/1000milliseconds = 1000cyclespermillisecond
